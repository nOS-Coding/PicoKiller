...
vm.runInContext(
  appJs + "\nthis.__exports = { crc32, buildConfig, toUf2, CONFIG_FLASH_OFFSET, UF2_FLASH_BASE, OS, PRANK, RP2350_ARM_S_FAMILY_ID };",
  ctx);
const { buildConfig, toUf2, CONFIG_FLASH_OFFSET, UF2_FLASH_BASE, OS, PRANK, RP2350_ARM_S_FAMILY_ID } = ctx.__exports;
...
const uf2 = toUf2(cfg, UF2_FLASH_BASE + CONFIG_FLASH_OFFSET, RP2350_ARM_S_FAMILY_ID);
